        ...
        <form
          ...
          <div className={s.wrapper}>
            <div className={s.box}>
              ...
              />
              <FormControl fullWidth>
                <InputLabel id="demo-simple-select-label">Жильё?</InputLabel>
                <Select
                  ...
                  <MenuItem value="true">
                    <div className={s.box_span}>Да</div>
                  </MenuItem>
                  <MenuItem value="false">
                    <div className={s.box_span}>Нет</div>
                  </MenuItem>
                </Select>
              </FormControl>
              <TextField
              ...
              <TextField
                ...
                name="email_info"
                type="email"
                label="E-mail адресс работадателя"
                variant="outlined"
                onChange={handleInputChange}
              />
              <div
