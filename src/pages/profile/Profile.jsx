...
const Profile = () => {
    ...
    return (
        <div className={s.container}>
            ...
            <ul className={s.ul}>
                <li onClick={() => activeComponent('company')} className={component === 'company' ? s.active : ''}>Данные о компании</li>
                <li onClick={() => activeComponent('branch')} className={component === 'branch' ? s.active : ''}>Филиалы</li>
            </ul>
