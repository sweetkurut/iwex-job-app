...
import { getCity, getMyBranch, getMyBranchDetail, patchBranchData, sendAddBranch } from '../../../../../store/slices/companyDetailsSlice';
        ...
        <>
            ...
            <form onSubmit={(e) => onSubmit(e)} className={s.container}>
                ...
                <div className={s.box_button}>
                    ...
                    <button className={s.btn} onClick={handlerComponent}>Отмена</button>
                </div>
            </form>
        </>
    )
